...
head:
  - tag: meta
    attrs:
      name: keywords
      content: CoreClaw, web scraping, data extraction, API documentation, worker platform, web crawler, data collection
  - tag: meta
    attrs:
      property: og:title
      content: CoreClaw Documentation
  - tag: meta
    attrs:
      property: og:description
      content: Complete documentation for CoreClaw - the powerful web data collection platform. Learn how to run Workers, develop custom scrapers, and integrate with our API.
  - tag: meta
    attrs:
      property: og:type
      content: website
  - tag: meta
    attrs:
      property: og:url
      content: https://docs.coreclaw.com
  - tag: meta
    attrs:
      property: og:image
      content: https://docs.coreclaw.com/logo.png
  - tag: link
    attrs:
      rel: canonical
      href: https://docs.coreclaw.com
---

<div class="breadcrumb-home">
	<a href="https://coreclaw.com" class="breadcrumb-home-link">Website Home</a>
...
<div class="hero-section">
	<div class="hero-title">CoreClaw <span class="hero-title-accent">Documentation</span></div>
	...
	<div class="hero-actions">
		<a href="/home" class="hero-btn hero-btn-primary">
			<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>
			Browse Docs
		</a>
		<a href="https://console.coreclaw.com/" class="hero-btn hero-btn-secondary" target="_blank" rel="noopener noreferrer">
...
<div class="nav-grid">
	<a href="/user-guide/run-worker/quick-start/" class="nav-card">
		...
		<h3 class="nav-card-title">Run Worker <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">Find and run Workers from CoreClaw Store to extract data</p>
	</a>
	<a href="/developer-guide/develop-worker/quick-start/" class="nav-card">
		...
		<h3 class="nav-card-title">Develop Worker <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">Create custom Workers using Python, Node.js, or Go</p>
	</a>
	<a href="/developer-guide/worker-definition/project-structure/" class="nav-card">
		<div class="nav-card-header">
			<div class="nav-card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div>
			<span class="nav-card-tag" style="--tag-color: #0f4c81">Dev</span>
		</div>
		<h3 class="nav-card-title">Worker Definition <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">Project structure, platform features, SDK modules, and examples</p>
	</a>
	...
	<a href="/developer-guide/worker-definition/browser-automation/overview/" class="nav-card">
		<div class="nav-card-header">
		...
		<h3 class="nav-card-title">Browser Automation <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">Playwright, Puppeteer, Selenium, DrissionPage integration guides</p>
	</a>
	<a href="/website-events/invitation-event/" class="nav-card">
		<div class="nav-card-header">
			...
			<span class="nav-card-tag" style="--tag-color: #ef4444">Events</span>
		</div>
		<h3 class="nav-card-title">Invitation Program <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">Invite friends to register and earn rewards</p>
	</a>
</div>
...
<div class="updates-grid">
	<div class="updates-panel">
		<div class="updates-panel-header">
			...
			<a href="/developer-guide/worker-definition/platform-features/proxy-support/" class="updates-panel-link">View all →</a>
		</div>
		<div class="updates-list">
			<a href="/developer-guide/worker-definition/platform-features/proxy-support/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #6366f1"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">Proxy Support</div>
					<div class="updates-item-desc">SOCKS5 proxy configuration for Workers</div>
				</div>
			</a>
			<a href="/developer-guide/worker-definition/platform-features/browser-fingerprinting/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #10b981"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">Browser Fingerprinting</div>
					<div class="updates-item-desc">Fingerprint browser environment for anti-detection</div>
				</div>
			</a>
			<a href="/developer-guide/worker-definition/platform-features/captcha-handling/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #f59e0b"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">CAPTCHA Handling</div>
					<div class="updates-item-desc">CDP-based CAPTCHA bypass functionality</div>
				</div>
			</a>
...
<div class="help-grid">
	<a href="/user-guide/user-faq/how-to-run-worker/" class="help-card">
