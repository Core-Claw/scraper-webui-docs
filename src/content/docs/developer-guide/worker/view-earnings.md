...
- Platform revenue share (if applicable)
...
- Platform revenue share ratio (e.g., developer program)
- Current service plan policies
...
- Your account balance reaches the minimum withdrawal threshold
- There are no pending revenue settlement tasks
