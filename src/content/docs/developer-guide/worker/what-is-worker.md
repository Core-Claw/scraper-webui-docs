...
## <Icon name="puzzle" /> What is a Worker?

A **Worker** is an automated script designed to extract data from websites. In CoreClaw, Workers are the core components that enable users to collect structured data from various online sources.
