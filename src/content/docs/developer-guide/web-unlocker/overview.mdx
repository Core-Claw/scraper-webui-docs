---
title: Overview
description: Welcome to the CafeScrasper Developer Tutorial Center! This document will help you get started with using the platform.
sidebar:
    order: 1
---
...
You focus on writing the extraction logic.
...
#### A. Fingerprint Browser

- Stable and consistent browser fingerprints
- Full JavaScript execution
- 支持Support for dynamically rendered pages动态加载页面
...
#### C. Captcha & Slider Verification Support

- Cloudflare Turnstile
- Google reCAPTCHA v2/v3
- DDataDome advanced slider challenges
...
<LinkCard
    ...
    description="Simply read the proxy authentication information injected by the platform and configure it correctly in the HTTP request, and the script will be automatically enabled every time it runs."
    href="/developer-guide/web-unlocker/socks5-network-proxy/"
/>
