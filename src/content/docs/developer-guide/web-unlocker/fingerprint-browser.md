...
The fingerprint environment is fully maintained by the platform.
**Developers do not need to deploy, purchase, or manage fingerprint browser instances** to access a stable and reliable browser runtime.
...
- **Usage**: Read `PROXY_AUTH` in your script and construct the WebSocket URL to connect
- **Pricing**: **Built-in, no extra cost, no additional setup required**
