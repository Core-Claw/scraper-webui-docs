...
Claude Desktop 通过 **Streamable HTTP** 传输协议支持 MCP。将以下配置添加到 Claude Desktop 的配置文件中。
...
保存配置文件后，**完全重启 Claude Desktop** 使配置生效。
...
![Claude Desktop MCP 配置](/src/assets/docs/mcp-3.png)
