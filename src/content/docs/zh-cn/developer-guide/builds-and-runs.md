...
- **浏览器是远程托管的** — 无需在项目中打包浏览器，通过 `ChromeWs` 环境变量（CDP/WebSocket）连接远程指纹浏览器池。详见 [浏览器指纹](/zh-cn/developer-guide/worker-definition/platform-features/browser-fingerprinting/)。
