---
title: 代理节点
description: 可用代理节点地区代码。
sidebar:
    order: 3
---

**说明**：以下为所有可用的代理节点代码及其对应的国家/地区名称。
...
| BJ   | Benin                    | BL   | Saint Bartholomew's                          | BM   | Bermuda                              |
...
| CF   | Central African          | CG   | Republic of the Congo                        | CH   | Switzerland                          |
| CI   | Cote d'Ivoire            | CK   | Cook Islands                                 | CL   | Chile                                |
| CM   | Cameroon                 | CN   | China                                        | CO   | Columbia                             |
