...
| status       | 0      | Integer | 否   | 运行状态：0 全部，1 就绪，2 运行中，3 成功，4 失败，5 已终止 |
| scraper_slug | -      | String  | 否   | Worker 唯一标识符 |
        ...
        "list": [
            {
                ...
                "scraper_slug": "coreclaw/google-maps-scraper",
                "results": 4,
                "usage": "0.065",
...
| err_msg       | -                          | String  | 错误消息 |
| slug          | 01KSFDS8XWTJME33C08XMCR6B9 | String  | 运行记录唯一标识符 |
| scraper_title | 新闻采集 20260305          | String  | Worker 标题 |
| scraper_slug  | coreclaw/google-maps-scraper | String  | Worker 唯一标识符 |
...
| version       | v1.0.5                     | String  | Worker 版本 |
