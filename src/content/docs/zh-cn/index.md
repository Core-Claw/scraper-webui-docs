...
head:
  - tag: meta
    attrs:
      name: keywords
      content: CoreClaw, 网页采集, 数据提取, API文档, 爬虫平台, 数据采集, 网络爬虫
  - tag: meta
    attrs:
      property: og:title
      content: CoreClaw 文档中心
  - tag: meta
    attrs:
      property: og:description
      content: CoreClaw 完整文档 - 强大的网页数据采集平台。学习如何运行 Worker、开发自定义爬虫以及集成 API。
  - tag: meta
    attrs:
      property: og:type
      content: website
  - tag: meta
    attrs:
      property: og:url
      content: https://docs.coreclaw.com/zh-cn
  - tag: meta
    attrs:
      property: og:image
  ...
  - tag: link
    attrs:
      rel: canonical
      href: https://docs.coreclaw.com/zh-cn
---
...
<div class="nav-grid">
	<a href="/zh-cn/user-guide/run-worker/quick-start/" class="nav-card">
		<div class="nav-card-header">
			...
			<span class="nav-card-tag" style="--tag-color: #f59e0b">入门</span>
		</div>
		<h3 class="nav-card-title">运行 Worker <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">从 CoreClaw Store 查找并运行 Worker 提取数据</p>
	</a>
	<a href="/zh-cn/developer-guide/develop-worker/quick-start/" class="nav-card">
		<div class="nav-card-header">
			...
			<span class="nav-card-tag" style="--tag-color: #6366f1">基础</span>
		</div>
		<h3 class="nav-card-title">开发 Worker <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">使用 Python、Node.js 或 Go 创建自定义 Worker</p>
	</a>
	<a href="/zh-cn/developer-guide/worker-definition/project-structure/" class="nav-card">
		<div class="nav-card-header">
			<div class="nav-card-icon"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg></div>
			<span class="nav-card-tag" style="--tag-color: #0f4c81">开发</span>
		</div>
		<h3 class="nav-card-title">Worker 定义 <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">项目结构、平台功能、SDK 模块和示例</p>
	</a>
	<a href="/zh-cn/api/" class="nav-card">
		...
		<p class="nav-card-desc">完整的 RESTful API 端点、参数和使用示例</p>
	</a>
	<a href="/zh-cn/developer-guide/worker-definition/browser-automation/overview/" class="nav-card">
		<div class="nav-card-header">
	...
	<a href="/zh-cn/website-events/invitation-event/" class="nav-card">
		...
		<h3 class="nav-card-title">邀请计划 <span class="nav-card-arrow">→</span></h3>
		<p class="nav-card-desc">邀请好友注册获取奖励</p>
	</a>
</div>
...
<div class="updates-grid">
	<div class="updates-panel">
		<div class="updates-panel-header">
			...
			<a href="/zh-cn/developer-guide/worker-definition/platform-features/proxy-support/" class="updates-panel-link">查看全部 →</a>
		</div>
		<div class="updates-list">
			<a href="/zh-cn/developer-guide/worker-definition/platform-features/proxy-support/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #6366f1"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">代理支持</div>
					<div class="updates-item-desc">Worker 的 SOCKS5 代理配置</div>
				</div>
			</a>
			<a href="/zh-cn/developer-guide/worker-definition/platform-features/browser-fingerprinting/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #10b981"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">浏览器指纹</div>
					<div class="updates-item-desc">指纹浏览器环境实现反检测</div>
				</div>
			</a>
			<a href="/zh-cn/developer-guide/worker-definition/platform-features/captcha-handling/" class="updates-item">
				<span class="updates-dot" style="--dot-color: #f59e0b"></span>
				<div class="updates-item-content">
					<div class="updates-item-title">验证码处理</div>
					<div class="updates-item-desc">基于 CDP 的验证码绕过功能</div>
				</div>
			</a>
			<a href="/zh-cn/api/" class="updates-item">
				...
				<div class="updates-item-content">
					...
					<div class="updates-item-desc">完整的 Worker / Run / Task / Account RESTful API 文档</div>
				</div>
			</a>
		</div>
	</div>
...
<div class="help-grid">
	<a href="/zh-cn/user-guide/user-faq/how-to-run-worker/" class="help-card">
		...
		<div class="help-card-desc">常见问题的快速解答</div>
	</a>
	<a href="https://coreclaw.com/blog" class="help-card" target="_blank">
		...
		<div class="help-card-desc">深度教程和行业洞察</div>
	</a>
