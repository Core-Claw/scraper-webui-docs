...
curl "https://openapi.coreclaw.com/api/scraper?slug=01KPD6M5YVHWCNQCRK32BD02TP"
```
...
| --------- | -------------------------------- | ------ | -------- | ------------------------- |
| slug      | 01KPD6M5YVHWCNQCRK32BD02TP      | String | Yes      | Unique Worker identifier (`scraper_slug`) |
