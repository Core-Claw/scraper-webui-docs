...
| `offset` | No | `integer` | Offset for the synchronous result window returned by runs or reruns. Constraints: default `0`; minimum 0. |
...
curl -X POST "https://openapi.coreclaw.com/api/v2/worker-runs/last/rerun" \
  ...
  --data '{"callback_url":"https://client.example.com/openapi/callback","is_async":true,"limit":20,"offset":1}'
```
