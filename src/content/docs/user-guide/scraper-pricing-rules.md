---
title: Template Pricing Rules
description: You only pay for the actual platform resources consumed during Template runs.
sidebar:
    order: 3
---
...
You only pay for the **actual platform resources consumed** during Template runs.
...
If you encounter any issues while using Templates, feel free to contact us at:[support@cafescraper.com](mailto:support@cafescraper.com)
:::
